...
import { flagUrl, phoneNoReg, removeSpace } from "../esm/constants";
import { countryDetails } from "../esm/CountryDetails";
...
export var PhoneInput = function (input) {
  var phoneNumber = input.phoneNumber,
    setPhoneNumber = input.setPhoneNumber;
  ...
  useEffect(
    function () {
      ...
      var callingCode = "+".concat(
        String(phoneNumber).replace(removeSpace, "")
      );
  ...
  document.addEventListener("click", function (event) {
    var isClickInside =
      specifiedElement === null || specifiedElement === void 0
        ? void 0
  ...
  var handleInputOnPaste = function (event) {
    var callingCode = "+".concat(
      event.clipboardData.getData("Text").slice(0, 4)
    );
    var trimCallingCode = "";
    for (
      var _i = 0, callingCode_1 = callingCode;
      _i < callingCode_1.length;
      _i++
    ) {
      var item = callingCode_1[_i];
      trimCallingCode = trimCallingCode + item;
      var country = countryDetails.find(function (item) {
        return (
          (item === null || item === void 0
            ? void 0
            : item.countryCallingCode) === trimCallingCode
        );
      });
      if (country) {
        setFlag(
          flagUrl(
            country === null || country === void 0
              ? void 0
              : country.countryCode
          )
        );
  ...
  return React.createElement(
    ...
    React.createElement(
      "div",
      {
        className: "phone-number-field ".concat(
      ...
      React.createElement(
        "span",
        {
          className: "subtitle-3 ml-1 ".concat(
    ...
    React.createElement(
      "div",
      {
        className: "phone-number-field__menu ".concat(
          displayList ? "d-block" : "d-none"
        ),
      },
      countryDetails.map(function (item) {
        return React.createElement(
          "div",
          {
            key:
              (item === null || item === void 0 ? void 0 : item.countryCode) +
              (item === null || item === void 0 ? void 0 : item.countryName),
            onClick: function () {
              setPhoneNumber(
                parseInt(
                  item === null || item === void 0
          ...
          React.createElement(
            ...
            {
              className:
                "phone-number-field__menu__item__country-name text-truncate",
            },
            item === null || item === void 0 ? void 0 : item.countryName
          ),
          React.createElement(
            "span",
            { className: "phone-number-field__menu__item__country-code ml-2" },
            "(",
            item === null || item === void 0 ? void 0 : item.countryCallingCode,
            ")"
          )
        );
      })
